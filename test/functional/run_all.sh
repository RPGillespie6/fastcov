...
coverage run -a ${TEST_DIR}/fastcov.py --zerocounters
test `find . -name *.gcda | wc -l` -eq 0

# Run ctest_1
${TEST_DIR}/fastcov.py --zerocounters  # Clear previous test coverage
ctest -R ctest_1

# Create a fastcov JSON to be filtered later
coverage run -a ${TEST_DIR}/fastcov.py --verbose -o basic.fastcov.json

# Test (basic report generation - no branches)
coverage run -a ${TEST_DIR}/fastcov.py --verbose --gcov gcov --exclude cmake_project/test/ --lcov -o test1.actual.info
cmp test1.actual.info ${TEST_DIR}/expected_results/test1.expected.info

coverage run -a ${TEST_DIR}/fastcov.py --exclude cmake_project/test/ -o test1.actual.fastcov.json
...
coverage run -a ${TEST_DIR}/fastcov.py -t FunctionalTest1 --exclude cmake_project/test/ --lcov -o test1.tn.actual.info
cmp test1.tn.actual.info ${TEST_DIR}/expected_results/test1.tn.expected.info

# Test (basic report info - with branches)
coverage run -a ${TEST_DIR}/fastcov.py --exceptional-branch-coverage --exclude cmake_project/test/ --lcov -o test2.actual.info
cmp test2.actual.info ${TEST_DIR}/expected_results/test2.expected.info

coverage run -a ${TEST_DIR}/fastcov.py --exceptional-branch-coverage --exclude cmake_project/test/ -o test2.actual.fastcov.json
...
coverage run -a ${TEST_DIR}/fastcov.py --exceptional-branch-coverage --verbose --include src/ --lcov -o test3.actual.info
...
coverage run -a ${TEST_DIR}/fastcov.py --exceptional-branch-coverage --verbose --exclude-gcda test1.cpp.gcda --lcov -o test4.actual.info
...
coverage run -a ${TEST_DIR}/fastcov.py --exceptional-branch-coverage --verbose --source-files ../src/source1.cpp ../src/source2.cpp --lcov -o test5.actual.info
...
coverage run -a ${TEST_DIR}/fastcov.py --exceptional-branch-coverage --process-gcno --source-files ../src/source1.cpp ../src/source2.cpp ../src/untested.cpp --lcov -o untested.actual.info
...
coverage run -a ${TEST_DIR}/fastcov.py --exceptional-branch-coverage --process-gcno --gcda-files ./test/CMakeFiles/test1.dir/__/src/source1.cpp.gcno ./test/CMakeFiles/test1.dir/__/src/source2.cpp.gcno ./src/CMakeFiles/untested.dir/untested.cpp.gcno --lcov -o untested2.actual.info
...
coverage run -a ${TEST_DIR}/fastcov.py --exclude /usr/include cmake_project/test/ --custom-exclusion-marker foo --lcov -o custom_exclude_line.actual.info
...
coverage run -a ${TEST_DIR}/fastcov.py -C basic.fastcov.json --source-files "${TEST_DIR}/cmake_project/src/source2.cpp" "${TEST_DIR}/cmake_project/src/source1.cpp" -o basic.fastcov3.actual.json
...
# Combine operation - NaN
coverage run -a ${TEST_DIR}/fastcov.py -C ${TEST_DIR}/expected_results/test2NaN.expected.info ${TEST_DIR}/expected_results/test1.tn.expected.info --lcov -o combine1.actual.info
cmp combine1.actual.info ${TEST_DIR}/expected_results/combine1.expected.info
...
${TEST_DIR}/fastcov.py --exceptional-branch-coverage --process-gcno --source-files ../src/source1.cpp --lcov -o combine.source1.actual.info
${TEST_DIR}/fastcov.py --exceptional-branch-coverage --process-gcno --source-files ../src/source2.cpp --lcov -o combine.source2.actual.info
...
coverage run -a ${TEST_DIR}/fastcov.py --exceptional-branch-coverage --exclude cmake_project/test/ --fallback-encodings latin1 --lcov -o test8.actual.info
...
coverage run -a ${TEST_DIR}/fastcov.py --exceptional-branch-coverage --exclude cmake_project/test/ --lcov -o test9.actual.info
...
coverage run -a ${TEST_DIR}/fastcov.py --exceptional-branch-coverage --exclude /usr/include cmake_project/test/ --include-br-lines-starting-with if else --lcov -o include_branches_sw.actual.info
...
coverage run -a ${TEST_DIR}/fastcov.py --exceptional-branch-coverage --exclude /usr/include cmake_project/test/ --exclude-br-lines-starting-with for if else --lcov -o exclude_branches_sw.actual.info
...
coverage run -a ${TEST_DIR}/fastcov.py --branch-coverage --exclude /usr/include cmake_project/test/ --lcov -o filter_branches.actual.info
...
coverage run -a ${TEST_DIR}/fastcov.py --exceptional-branch-coverage --source-files ../src/source1.cpp --lcov -o multitest.actual.info
...
RUN_DIR=${PWD}
pushd ${TEST_DIR}
COVERAGE_FILE=${RUN_DIR}/.coverage.other_dir coverage run -a ${TEST_DIR}/fastcov.py --exceptional-branch-coverage --source-files cmake_project/src/source1.cpp --lcov -o ${RUN_DIR}/multitest_nonbuild_dir.actual.info
...
coverage run -a ${TEST_DIR}/fastcov.py  --lcov -o redirected.output.info > redirected.output.info.log 2>redirected.output.info.log

# Test (default name for json)
coverage run -a ${TEST_DIR}/fastcov.py
test -f "coverage.json"

# Test (default name for lcov)
coverage run -a ${TEST_DIR}/fastcov.py --lcov
...
touch empty.gcno
rc=0
coverage run -a ${TEST_DIR}/fastcov.py --process-gcno || rc=$?
test $rc -eq 8
